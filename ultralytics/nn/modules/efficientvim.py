...
__all__ = ['EfficientViMBlock', 'EfficientViMBlock_Enhance']
...
class ConvolutionalGLU(nn.Module):
    def __init__(self, in_features, hidden_features=None, out_features=None, act_layer=nn.GELU, drop=0.) -> None:
        ...
        hidden_features = int(2 * hidden_features / 4)
...
class EfficientViMBlock_Enhance(EfficientViMBlock):
    def __init__(self, dim, mlp_ratio=1, ssd_expand=0.5, state_dim=32):
