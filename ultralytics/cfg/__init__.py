...
CFG_FLOAT_KEYS = frozenset(
    {  # integer or float arguments, i.e. x=2 and x=2.0
        ...
        "workspace",
        "batch",
        "mask_loss_weight",  # SID mask loss weight
        "mask_alpha",        # SID foreground loss weight
        "mask_beta",         # SID background loss weight
        "mask_gamma",        # SID complementarity loss weight
    }
)
